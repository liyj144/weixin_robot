...
var tuling_rb = function(tuling_config, res, str, debug){
    logger.debug("get str form client " + str + ", userid is " + tuling_config.userid);
    var data = {"key": tuling_config.app_id, "info": str, "loc": tuling_config.loc, "userid": tuling_config.userid};
    console.log(data);
    request.post({
        url: tuling_config.url,
        form: data,
        json: true,
        encoding: 'utf8'
    }, function(error, response, body){
